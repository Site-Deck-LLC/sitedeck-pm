...
describe('schedule.service', () => {
    ...
    describe('getSchedulePerformance', () => {
        ...
        beforeEach(() => {
            jest.clearAllMocks();
            (0, prisma_1.setPrismaClient)(mockPrismaPerf);
        });
        it('throws when project not found', async () => {
            mockProjectFindUnique.mockResolvedValue(null);
            await expect((0, schedule_service_1.getSchedulePerformance)('proj-1')).rejects.toThrow('Project start date required');
        });
        ...
        it('returns daily data points from start to end', async () => {
            ...
            const result = await (0, schedule_service_1.getSchedulePerformance)('proj-1');
